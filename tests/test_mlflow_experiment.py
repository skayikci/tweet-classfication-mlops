...
class TestMLflowExperiment(unittest.TestCase):
    ...
    @patch("src.tweet_classification.setup_mlflow")
    ...
    @patch("src.tweet_classification.joblib.dump")
    @patch("src.tweet_classification.mlflow")
    def test_run_experiment_logs_and_returns_metrics(
        self, mock_mlflow, mock_joblib_dump
    ):
